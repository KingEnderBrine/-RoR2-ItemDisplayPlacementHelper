...
* **{m:ruleType}** - Rule type as ***ItemDisplayRuleType.Type***
...
# Bottom panel
![](https://github.com/KingEnderBrine/-RoR2-ItemDisplayPlacementHelper/blob/master/Screenshots/12.png?raw=true)

### Enable animator
Toggle animator on the model object.
...
### Animator parameters
Click a button to show current animator parameters
